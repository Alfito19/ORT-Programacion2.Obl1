    ...
    public static void main(String[] args){
        ...
        while(deseaJugar){
            ...
            if(primerRespuesta.equalsIgnoreCase("Y")){           
                ...
                System.out.println("¿Con qué tipo de tablero le gustarí­a jugar?");
                ...
                // Declara "tercerRespuesta (fila)" y "cuartaRespuesta (col)" para luego en el try-catch, transformarlo a numero, en caso de que no pueda lo tomarÃ¡ como excepciÃ³n y verificarÃ¡ si es una de las opciones [X, H, S]. En caso de que se pueda transformar a numero, lo procesarÃ¡ como movimiento chequeando que sea un movimiento vÃ¡lido.
                ...
                while(ListoParaJugar){
                    ...
                    // En caso de que tercerRespuesta o cuartaRespuesta no sea numero, confirmamos que sea H para mostrar historial o S para mostrar una solucion, en caso de ser X no entrarÃ­a al while y en cualquier otro caso mostramos error y opciones nuevamente
                    catch(NumberFormatException e){
                        if(!interactuado){
                            System.out.println("Entrada no válida, recuerda que las opciones son: \n- X para cerrar el juego \n- H para ver el historial de movimientos \n- S para ver una solucion \n- Fila y columna correspondiente al movimiento\n");
                        }
